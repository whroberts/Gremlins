...
void AGremlinsCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AGremlinsCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGremlinsCharacter::Move);
...
void AGremlinsCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGremlinsCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
